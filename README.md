...
موارد نقض شناسایی شده در گام دوم، با استفاده از الگوهای طراحی و اصول SOLID (به ویژه DIP و OCP) رفع گردیدند. این تغییرات در پوشه Step-03-with-OOD منعکس شده است.
